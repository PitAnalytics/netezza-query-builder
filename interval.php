...
AND CAST(SUBSTR(BUDAT,7,2) AS INT64) BETWEEN ".$dia_1." AND ".$dia_2."
  ...
  echo("--"." dia: ".$dia_1."<br/>");
    ...
    for($i=0; $i<$size; $i++){
      ...
      if($r===1){
        ...
        echo("INSERT INTO crude_bseg_".$sociedad."(BUKRS,KOSTL,BLDAT,BUDAT,SGTXT,HKONT,BLART,DMBTR,WRBTR,PSWSL,PSWBT,PRCTR,LIFNR,KUNNR,PROJK,DBBLG,ZUONR,SHKZG,BELNR) ");
        echo('<br/>');
